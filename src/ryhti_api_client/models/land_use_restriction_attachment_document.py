...
class LandUseRestrictionAttachmentDocument(BaseModel):
    ...
    land_use_restriction_attachment_document_uri: Optional[StrictStr] = Field(
        default=None,
        ...
        alias="landUseRestrictionAttachmentDocumentUri",
    )
    ...
    document_creator_operators: Optional[List[LandUseRestrictionOperator]] = Field(
        default=None,
        description="Asiakirjan laatijat",
        alias="documentCreatorOperators",
    )
    related_land_use_restriction_documents: Optional[List[StrictStr]] = Field(
        default=None,
        description="Liiteasiakirjaan liittyvät muut liiteasiakirjat",
        alias="relatedLandUseRestrictionDocuments",
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # and model_fields_set contains the field
        if (
            self.related_land_use_restriction_documents is None
            and "related_land_use_restriction_documents" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "landUseRestrictionAttachmentDocumentUri": obj.get(
                    "landUseRestrictionAttachmentDocumentUri"
                ),
