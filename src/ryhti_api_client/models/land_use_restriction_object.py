...
class LandUseRestrictionObject(BaseModel):
    ...
    land_use_restriction_object_uri: Optional[StrictStr] = Field(
        default=None,
        ...
        alias="landUseRestrictionObjectUri",
    )
    related_properties: Optional[List[StrictStr]] = Field(
        default=None,
        description="Tieto liittyvistä kiinteistöistä, joita rajoitus koskee",
        alias="relatedProperties",
    )
    related_plans: Optional[List[RelatedPlan]] = Field(
        default=None,
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if (
            self.related_properties is None
            and "related_properties" in self.model_fields_set
        ):
