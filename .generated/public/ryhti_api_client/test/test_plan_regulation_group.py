...
class TestPlanRegulationGroup(unittest.TestCase):
    """PlanRegulationGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlanRegulationGroup:
        """Test PlanRegulationGroup
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PlanRegulationGroup`
        """
        model = PlanRegulationGroup()
        if include_optional:
    ...
    def testPlanRegulationGroup(self):
        """Test PlanRegulationGroup"""
