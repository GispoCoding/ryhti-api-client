...
class NumericRange(AttributeValue):
    """
    NumericRange
    """  # noqa: E501

    data_type: StrictStr = Field(
        description='Pakollinen arvo: "NumericRange"', alias="dataType"
    )
    ...
    def data_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["NumericRange"]):
            raise ValueError("must be one of enum values ('NumericRange')")
        return value
