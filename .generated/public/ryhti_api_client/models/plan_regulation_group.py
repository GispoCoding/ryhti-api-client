...
class PlanRegulationGroup(BaseModel):
    ...
    plan_regulation_group_uri: Optional[StrictStr] = Field(
        default=None,
    ...
    letter_identifier: Optional[StrictStr] = Field(
        default=None, description="KirjainTunnus", alias="letterIdentifier"
    )
    plan_regulations: List[PlanRegulation] = Field(
        description="Kaavamääräykset", alias="planRegulations"
    )
    ...
    color_number: Optional[StrictStr] = Field(
        default=None, description="Värikoodi", alias="colorNumber"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if (
            self.letter_identifier is None
            and "letter_identifier" in self.model_fields_set
        ):
