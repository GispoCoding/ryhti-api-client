...
class Plan(BaseModel):
    ...
    partially_cancelled_plan_objects: Optional[List[PartiallyCancelledPlanObjectInfo]] = Field(default=None, description="// Osittain kumottavat kaavakohteet", alias="partiallyCancelledPlanObjects")
    plan_objects: Annotated[List[PlanObject], Field(min_length=1)] = Field(description="Kaavakohteet", alias="planObjects")
    plan_regulation_groups: Annotated[List[PlanRegulationGroup], Field(min_length=1)] = Field(description="Kaavakohteen määräysryhmät", alias="planRegulationGroups")
    ...
    related_plan_object_regulation_group_relations: Optional[List[RelatedPlanObjectRegulationGroupRelation]] = Field(default=None, alias="relatedPlanObjectRegulationGroupRelations")
    __properties: ClassVar[List[str]] = ["planKey", "planUri", "lifeCycleStatus", "legalEffectOfLocalMasterPlans", "scale", "planMaps", "geographicalArea", "planDescription", "planAnnexes", "otherPlanMaterials", "planCancellationInfos", "planReport", "generalRegulationGroups", "periodOfValidity", "approvalDate", "planners", "partiallyCancelledPlanObjects", "planObjects", "planRegulationGroups", "planRegulationGroupRelations", "relatedPlanObjectRegulationGroupRelations"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.partially_cancelled_plan_objects:
            for _item_partially_cancelled_plan_objects in self.partially_cancelled_plan_objects:
        ...
        # and model_fields_set contains the field
        if self.partially_cancelled_plan_objects is None and "partially_cancelled_plan_objects" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "partiallyCancelledPlanObjects": [PartiallyCancelledPlanObjectInfo.from_dict(_item) for _item in obj["partiallyCancelledPlanObjects"]] if obj.get("partiallyCancelledPlanObjects") is not None else None,
