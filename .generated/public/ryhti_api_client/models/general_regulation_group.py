...
class GeneralRegulationGroup(BaseModel):
    """
    Yleismääräysryhmä
    """  # noqa: E501

    general_regulation_group_key: UUID = Field(
        description="Tiedon tuottajatahon tietojärjestelmän generoima kohteen versioriippumaton tunnus",
        alias="generalRegulationGroupKey",
    )
    general_regulation_group_uri: Optional[StrictStr] = Field(
        default=None,
        ...
        alias="generalRegulationGroupUri",
    )
    title_of_plan_regulation: LanguageString = Field(
        description="Lokalisoitu merkkijono-luokka eri kielille. Lisää vähintään yksi kieli.",
        alias="titleOfPlanRegulation",
    )
    plan_regulations: Optional[List[PlanRegulation]] = Field(
        default=None, description="Kaavamääräykset", alias="planRegulations"
    )
    plan_recommendations: Optional[List[PlanRecommendation]] = Field(
        default=None, description="Kaavasuositukset", alias="planRecommendations"
    )
    group_number: Optional[StrictInt] = Field(
        default=None, description="Ryhmänumero", alias="groupNumber"
    )
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.plan_regulations:
            for _item_plan_regulations in self.plan_regulations:
                _items.append(
                    _item_plan_regulations.to_dict()
                    if _item_plan_regulations is not None
                    else None
                )
        ...
        if self.plan_recommendations:
            for _item_plan_recommendations in self.plan_recommendations:
                _items.append(
                    _item_plan_recommendations.to_dict()
                    if _item_plan_recommendations is not None
                    else None
                )
            _dict["planRecommendations"] = _items
        # set to None if plan_regulations (nullable) is None
        # and model_fields_set contains the field
        if (
            self.plan_regulations is None
            and "plan_regulations" in self.model_fields_set
        ):
            _dict["planRegulations"] = None

        # set to None if plan_recommendations (nullable) is None
        # and model_fields_set contains the field
        if (
            self.plan_recommendations is None
            and "plan_recommendations" in self.model_fields_set
        ):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "generalRegulationGroupKey": obj.get("generalRegulationGroupKey"),
                "generalRegulationGroupUri": obj.get("generalRegulationGroupUri"),
                "titleOfPlanRegulation": LanguageString.from_dict(
                    obj["titleOfPlanRegulation"]
                )
                if obj.get("titleOfPlanRegulation") is not None
                else None,
                "planRegulations": [
                    PlanRegulation.from_dict(_item) for _item in obj["planRegulations"]
                ]
                if obj.get("planRegulations") is not None
                else None,
                "planRecommendations": [
                    PlanRecommendation.from_dict(_item)
                    for _item in obj["planRecommendations"]
                ]
                if obj.get("planRecommendations") is not None
                else None,
