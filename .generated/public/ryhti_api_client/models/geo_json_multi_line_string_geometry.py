...
class GeoJsonMultiLineStringGeometry(GeoJsonGeometry):
    """
    GeoJsonMultiLineStringGeometry
    """  # noqa: E501

    type: StrictStr = Field(
        description='Geometriatyyppi. Pakollinen arvo: "MultiLineString"'
    )
    coordinates: List[List[List[Union[StrictFloat, StrictInt]]]] = Field(
        description="Koordinaatit",
        json_schema_extra={
            "examples": [
                "[ [[100.0, 0.0], [101.0, 1.0]], [[101.0, 1.0], [100.0, 1.0]] ]"
            ]
        },
    )
