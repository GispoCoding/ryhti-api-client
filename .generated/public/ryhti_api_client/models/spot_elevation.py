...
class SpotElevation(AttributeValue):
    """
    SpotElevation
    """  # noqa: E501

    data_type: StrictStr = Field(
        description='Pakollinen arvo: "SpotElevation"', alias="dataType"
    )
    ...
    def data_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["SpotElevation"]):
            raise ValueError("must be one of enum values ('SpotElevation')")
        return value
