...
class PlanCancellationInfo(BaseModel):
    ...
    cancelled_plan_object_uris: Optional[List[StrictStr]] = Field(
        default=None,
        ...
        alias="cancelledPlanObjectUris",
    )
    cancelled_regulation_uris: Optional[List[StrictStr]] = Field(
        default=None,
        ...
        alias="cancelledRegulationUris",
    )
    cancelled_recommendation_uris: Optional[List[StrictStr]] = Field(
        default=None,
        ...
        alias="cancelledRecommendationUris",
    )
