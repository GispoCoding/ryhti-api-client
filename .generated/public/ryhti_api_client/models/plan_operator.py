...
class PlanOperator(BaseModel):
    ...
    organization_name: Optional[StrictStr] = Field(
        default=None, description="OrganisaatioNimi", alias="organizationName"
    )
