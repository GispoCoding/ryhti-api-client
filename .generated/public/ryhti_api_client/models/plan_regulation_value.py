...
PLANREGULATIONVALUE_ONE_OF_SCHEMAS = [
    "CodeValue",
    "DecimalRange",
    "DecimalValue",
    "IdentifierValue",
...
class PlanRegulationValue(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        instance = PlanRegulationValue.model_construct()
        error_messages = []
        match = 0
        ...
        if not isinstance(v, NumericValue):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `NumericValue`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, NumericRange):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `NumericRange`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, PositiveNumericValue):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `PositiveNumericValue`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, PositiveNumericRange):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `PositiveNumericRange`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, DecimalValue):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `DecimalValue`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, DecimalRange):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `DecimalRange`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, PositiveDecimalValue):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `PositiveDecimalValue`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, PositiveDecimalRange):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `PositiveDecimalRange`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, SpotElevation):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `SpotElevation`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, IdentifierValue):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `IdentifierValue`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, LocalizedTextValue):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `LocalizedTextValue`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, TimePeriodValue):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `TimePeriodValue`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, TimePeriodDateOnlyValue):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `TimePeriodDateOnlyValue`"
            )
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when setting `actual_instance` in PlanRegulationValue with oneOf schemas: CodeValue, DecimalRange, DecimalValue, IdentifierValue, LocalizedTextValue, NumericRange, NumericValue, PositiveDecimalRange, PositiveDecimalValue, PositiveNumericRange, PositiveNumericValue, SpotElevation, TextValue, TimePeriodDateOnlyValue, TimePeriodValue. Details: "
                + ", ".join(error_messages)
            )
        elif match == 0:
            # no match
            raise ValueError(
                "No match found when setting `actual_instance` in PlanRegulationValue with oneOf schemas: CodeValue, DecimalRange, DecimalValue, IdentifierValue, LocalizedTextValue, NumericRange, NumericValue, PositiveDecimalRange, PositiveDecimalValue, PositiveNumericRange, PositiveNumericValue, SpotElevation, TextValue, TimePeriodDateOnlyValue, TimePeriodValue. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: Optional[str]) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when deserializing the JSON string into PlanRegulationValue with oneOf schemas: CodeValue, DecimalRange, DecimalValue, IdentifierValue, LocalizedTextValue, NumericRange, NumericValue, PositiveDecimalRange, PositiveDecimalValue, PositiveNumericRange, PositiveNumericValue, SpotElevation, TextValue, TimePeriodDateOnlyValue, TimePeriodValue. Details: "
                + ", ".join(error_messages)
            )
        elif match == 0:
            # no match
