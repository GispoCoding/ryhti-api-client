...
class PlanObject(BaseModel):
    ...
    plan_object_uri: Optional[StrictStr] = Field(
        default=None,
    ...
    life_cycle_status: StrictStr = Field(
        description='Kaavakohteen elinkaaren tila. Käytetään koodistoa <a href="http://uri.suomi.fi/codelist/rytj/kaavaelinkaari">http://uri.suomi.fi/codelist/rytj/kaavaelinkaari</a>',
        alias="lifeCycleStatus",
    )
    underground_status: Annotated[str, Field(min_length=1, strict=True)] = Field(
        description='Luokittelu maanalaista ja maanpäällistä maankäyttöä koskeviin kaavakohteisiin. Käytetään koodistoa <a href="http://uri.suomi.fi/codelist/rytj/RY_MaanalaisuudenLaji">http://uri.suomi.fi/codelist/rytj/RY_MaanalaisuudenLaji</a>',
        alias="undergroundStatus",
    )
    ...
    related_plan_source_data_keys: Optional[List[UUID]] = Field(
        default=None,
        description="Viittaus (GUID) kaavan mukana toimitettavaan lähtötietoaineistoon sisältyvään tietokohteeseen, joka liittyy kaavakohteeseen. Esim. Pohjavesialue.  Päivitysvaiheessa tämän listan kuuluu olla tyhjä.",
        alias="relatedPlanSourceDataKeys",
    )
    related_plan_source_data_uris: Optional[List[StrictStr]] = Field(
        default=None,
        ...
        alias="relatedPlanSourceDataUris",
    )
    period_of_validity: Optional[TimePeriodDateOnly] = Field(
        default=None, description="VoimassaoloAika", alias="periodOfValidity"
    )
    object_number: Optional[StrictInt] = Field(
        default=None, description="Kohdenumero", alias="objectNumber"
    )
    related_plan_object_keys: Optional[List[UUID]] = Field(
        default=None,
        description="LiittyväKohde UUID/localID",
        alias="relatedPlanObjectKeys",
    )
    related_plan_object_uris: Optional[List[StrictStr]] = Field(
        default=None,
        description="Liittyvä jo tallennetun kaavakohten Uri",
        alias="relatedPlanObjectUris",
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # and model_fields_set contains the field
        if (
            self.related_plan_source_data_keys is None
            and "related_plan_source_data_keys" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.related_plan_source_data_uris is None
            and "related_plan_source_data_uris" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.related_plan_object_keys is None
            and "related_plan_object_keys" in self.model_fields_set
        ):
            _dict["relatedPlanObjectKeys"] = None

        # set to None if related_plan_object_uris (nullable) is None
        # and model_fields_set contains the field
        if (
            self.related_plan_object_uris is None
            and "related_plan_object_uris" in self.model_fields_set
        ):
            _dict["relatedPlanObjectUris"] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "relatedPlanObjectUris": obj.get("relatedPlanObjectUris"),
            }
        )
        return _obj
