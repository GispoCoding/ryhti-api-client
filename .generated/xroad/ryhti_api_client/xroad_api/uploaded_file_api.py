...
class UploadedFileApi:
    ...
    def api_file_post(
        ...
        municipality_id: Annotated[Optional[StrictStr], Field(description="Jos käyttäjällä on oikeus useampaan kuntaan tulee pyynnön sisältää kuntaId, jolle tiedosto tuodaan. Vain toinen id on sallittu.")] = None,
        region_id: Annotated[Optional[StrictStr], Field(description="Jos käyttäjällä on oikeus useampaan maakuntaan tulee pyynnön sisältää maakuntaId, jolle tiedosto tuodaan. Vain toinen id on sallittu.")] = None,
        ...
        _param = self._api_file_post_serialize(
            file=file,
    ...
    @validate_call
    def api_file_post_with_http_info(
        self,
        file: Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
        municipality_id: Annotated[Optional[StrictStr], Field(description="Jos käyttäjällä on oikeus useampaan kuntaan tulee pyynnön sisältää kuntaId, jolle tiedosto tuodaan. Vain toinen id on sallittu.")] = None,
        region_id: Annotated[Optional[StrictStr], Field(description="Jos käyttäjällä on oikeus useampaan maakuntaan tulee pyynnön sisältää maakuntaId, jolle tiedosto tuodaan. Vain toinen id on sallittu.")] = None,
    ...
    @validate_call
    def api_file_post_without_preload_content(
        self,
        file: Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
        municipality_id: Annotated[Optional[StrictStr], Field(description="Jos käyttäjällä on oikeus useampaan kuntaan tulee pyynnön sisältää kuntaId, jolle tiedosto tuodaan. Vain toinen id on sallittu.")] = None,
        region_id: Annotated[Optional[StrictStr], Field(description="Jos käyttäjällä on oikeus useampaan maakuntaan tulee pyynnön sisältää maakuntaId, jolle tiedosto tuodaan. Vain toinen id on sallittu.")] = None,
