...
class BindingPlotDivisionMatterApi:
    ...
    def _api_binding_plot_division_matter_permanent_binding_plot_division_identifier_get_serialize(
        ...
        if permanent_binding_plot_division_identifier is not None:
            _path_params['permanentBindingPlotDivisionIdentifier'] = permanent_binding_plot_division_identifier
    ...
    def _api_binding_plot_division_matter_permanent_binding_plot_division_identifier_phase_binding_plot_division_matter_phase_key_get_serialize(
        ...
        if binding_plot_division_matter_phase_key is not None:
            _path_params['bindingPlotDivisionMatterPhaseKey'] = binding_plot_division_matter_phase_key
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
    ...
    def api_binding_plot_division_matter_permanent_binding_plot_division_identifier_phase_binding_plot_division_matter_phase_key_post(
        self,
        permanent_binding_plot_division_identifier: Annotated[StrictStr, Field(description="Pysyvä sitovan tonttijaon tunnus sitovan tonttijaon asialle.")],
        binding_plot_division_matter_phase_key: Annotated[StrictStr, Field(description="Pysyvä yksilöivä tunnus sitovan tonttijaon asian vaiheelle.")],
        binding_plot_division_matter_phase: Annotated[BindingPlotDivisionMatterPhase, Field(description="Lisättävä sitovan tonttijaon asian vaihe kokonaisuudessaan.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def api_binding_plot_division_matter_permanent_binding_plot_division_identifier_plan_effects_post(
        self,
        permanent_binding_plot_division_identifier: Annotated[StrictStr, Field(description="Pysyvä yksilöivä tunnus sitovan tonttijaon asialle.")],
    ...
    def api_binding_plot_division_matter_permanent_binding_plot_division_identifier_post(
        self,
        permanent_binding_plot_division_identifier: Annotated[StrictStr, Field(description="Pysyvä yksilöivä tunnus sitovan tonttijaon asialle.")],
        binding_plot_division_matter_create: Annotated[BindingPlotDivisionMatterCreate, Field(description="Sitovan tonttijaon asia.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def api_binding_plot_division_matter_permanent_binding_plot_division_identifier_post_0(
        self,
        reserve_permanent_binding_plot_division_identifier_command: Annotated[ReservePermanentBindingPlotDivisionIdentifierCommand, Field(description="Tiedot jotka tarvitaan pysyvän tunnuksen varaamiseen.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def api_binding_plot_division_matter_permanent_binding_plot_division_identifier_validate_post(
        self,
        permanent_binding_plot_division_identifier: Annotated[StrictStr, Field(description="Pysyvä sitovan tonttijaon tunnus sitovan tonttijaon asialle.")],
        binding_plot_division_matter_create: Annotated[BindingPlotDivisionMatterCreate, Field(description="Validoitava sitovan tonttijaon asian sisältäen ensimmäisen sitovan tonttijaon asian vaiheen.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
