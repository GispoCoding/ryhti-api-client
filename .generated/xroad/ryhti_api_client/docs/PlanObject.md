...
------------ | ------------- | ------------- | -------------
**plan_object_key** | **UUID** | Tiedon tuottajatahon tietojärjestelmän generoima kohteen versioriippumaton tunnus | 
...
**vertical_limit** | [**DecimalRange**](DecimalRange.md) | PystysuuntainenRajaus | [optional] 
**related_plan_source_data_keys** | **List[UUID]** | Viittaus (GUID) kaavan mukana toimitettavaan lähtötietoaineistoon sisältyvään tietokohteeseen, joka liittyy kaavakohteeseen. Esim. Pohjavesialue.  Päivitysvaiheessa tämän listan kuuluu olla tyhjä. | [optional] 
...
**related_plan_object_keys** | **List[UUID]** | LiittyväKohde UUID/localID | [optional] 
**related_plan_object_uris** | **List[str]** | Liittyvä jo tallennetun kaavakohten Uri | [optional] 
