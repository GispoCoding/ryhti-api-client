...
class InteractionEvent(BaseModel):
    ...
    interaction_event_key: StrictStr = Field(
        description="Tiedon tuottajatahon tietojärjestelmän generoima kohteen versioriippumaton tunnus",
        alias="interactionEventKey",
    )
    interaction_event_uri: Optional[StrictStr] = Field(
        default=None,
        ...
        alias="interactionEventUri",
    )
    interaction_event_type: StrictStr = Field(
        description='Vuorovaikutustapahtuman tyyppi. Käytetään koodistoa <a href="http://uri.suomi.fi/codelist/rytj/RY_KaavanVuorovaikutustapahtumanLaji">http://uri.suomi.fi/codelist/rytj/RY_KaavanVuorovaikutustapahtumanLaji</a>',
        alias="interactionEventType",
    )
    ...
    additional_information_link: Optional[StrictStr] = Field(
        default=None, description="Lisätietolinkki", alias="additionalInformationLink"
    )
    ...
    related_documents: Optional[List[PlanAttachmentDocument]] = Field(
        default=None, description="Liittyvät asiakirjat", alias="relatedDocuments"
    )
    ...
    def interaction_event_type_validate_enum(cls, value):
        ...
        if value not in set(
            [
                "http://uri.suomi.fi/codelist/rytj/RY_KaavanVuorovaikutustapahtumanLaji/code/01",
                "http://uri.suomi.fi/codelist/rytj/RY_KaavanVuorovaikutustapahtumanLaji/code/02",
                "http://uri.suomi.fi/codelist/rytj/RY_KaavanVuorovaikutustapahtumanLaji/code/03",
                "http://uri.suomi.fi/codelist/rytj/RY_KaavanVuorovaikutustapahtumanLaji/code/04",
                "http://uri.suomi.fi/codelist/rytj/RY_KaavanVuorovaikutustapahtumanLaji/code/05",
                "http://uri.suomi.fi/codelist/rytj/RY_KaavanVuorovaikutustapahtumanLaji/code/06",
                "http://uri.suomi.fi/codelist/rytj/RY_KaavanVuorovaikutustapahtumanLaji/code/07",
                "http://uri.suomi.fi/codelist/rytj/RY_KaavanVuorovaikutustapahtumanLaji/code/08",
            ]
        ):
            raise ValueError(
                "must be one of enum values ('http://uri.suomi.fi/codelist/rytj/RY_KaavanVuorovaikutustapahtumanLaji/code/01', 'http://uri.suomi.fi/codelist/rytj/RY_KaavanVuorovaikutustapahtumanLaji/code/02', 'http://uri.suomi.fi/codelist/rytj/RY_KaavanVuorovaikutustapahtumanLaji/code/03', 'http://uri.suomi.fi/codelist/rytj/RY_KaavanVuorovaikutustapahtumanLaji/code/04', 'http://uri.suomi.fi/codelist/rytj/RY_KaavanVuorovaikutustapahtumanLaji/code/05', 'http://uri.suomi.fi/codelist/rytj/RY_KaavanVuorovaikutustapahtumanLaji/code/06', 'http://uri.suomi.fi/codelist/rytj/RY_KaavanVuorovaikutustapahtumanLaji/code/07', 'http://uri.suomi.fi/codelist/rytj/RY_KaavanVuorovaikutustapahtumanLaji/code/08')"
            )
        return value
