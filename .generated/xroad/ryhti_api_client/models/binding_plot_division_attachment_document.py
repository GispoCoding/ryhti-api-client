...
class BindingPlotDivisionAttachmentDocument(BaseModel):
    ...
    binding_plot_division_attachment_document_uri: Optional[StrictStr] = Field(
        default=None,
        ...
        alias="bindingPlotDivisionAttachmentDocumentUri",
    )
    ...
    document_creator_operators: Optional[List[BindingPlotDivisionOperator]] = Field(
        default=None,
        description="Asiakirjan laatijat",
        alias="documentCreatorOperators",
    )
    related_binding_plot_division_attachment_documents: Optional[List[StrictStr]] = (
        Field(
            default=None,
            description="Liittyvät asiakirjat",
            alias="relatedBindingPlotDivisionAttachmentDocuments",
        )
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # and model_fields_set contains the field
        if (
            self.related_binding_plot_division_attachment_documents is None
            and "related_binding_plot_division_attachment_documents"
        ...
        _obj = cls.model_validate(
            {
                ...
                "bindingPlotDivisionAttachmentDocumentUri": obj.get(
                    "bindingPlotDivisionAttachmentDocumentUri"
                ),
                ...
                "documentCreatorOperators": [
                    BindingPlotDivisionOperator.from_dict(_item)
                    for _item in obj["documentCreatorOperators"]
                ]
                if obj.get("documentCreatorOperators") is not None
                else None,
                "relatedBindingPlotDivisionAttachmentDocuments": obj.get(
                    "relatedBindingPlotDivisionAttachmentDocuments"
                ),
            }
        )
