...
class LandUseRestrictionOperator(BaseModel):
    ...
    land_use_restriction_operator_key: StrictStr = Field(
        description="Tiedon tuottajatahon tietojärjestelmän generoima kohteen versioriippumaton tunnus.",
        alias="landUseRestrictionOperatorKey",
    )
    land_use_restriction_operator_uri: Optional[StrictStr] = Field(
        default=None,
        ...
        alias="landUseRestrictionOperatorUri",
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "landUseRestrictionOperatorKey": obj.get(
                    "landUseRestrictionOperatorKey"
                ),
                "landUseRestrictionOperatorUri": obj.get(
                    "landUseRestrictionOperatorUri"
                ),
