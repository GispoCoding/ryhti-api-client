...
class LandUseRestrictionHandlingEvent(BaseModel):
    ...
    handling_event_uri: Optional[StrictStr] = Field(default=None, alias="handlingEventUri")
    type: StrictStr = Field(description="Laji. Käytetään koodistoa <a href=\"http://uri.suomi.fi/codelist/rytj/alueidenkaytonRajoituksenKasittelytapahtumanLaji\">http://uri.suomi.fi/codelist/rytj/alueidenkaytonRajoituksenKasittelytapahtumanLaji</a>")
    ...
    event_time: Optional[TimePeriod] = Field(default=None, description="Tapahtuman aika (hetki tai aikaväli)", alias="eventTime")
    __properties: ClassVar[List[str]] = ["handlingEventKey", "handlingEventUri", "type", "name", "description", "eventTime"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['http://uri.suomi.fi/codelist/rytj/alueidenkaytonRajoituksenKasittelytapahtumanLaji/code/01', 'http://uri.suomi.fi/codelist/rytj/alueidenkaytonRajoituksenKasittelytapahtumanLaji/code/02', 'http://uri.suomi.fi/codelist/rytj/alueidenkaytonRajoituksenKasittelytapahtumanLaji/code/03', 'http://uri.suomi.fi/codelist/rytj/alueidenkaytonRajoituksenKasittelytapahtumanLaji/code/04']):
            raise ValueError("must be one of enum values ('http://uri.suomi.fi/codelist/rytj/alueidenkaytonRajoituksenKasittelytapahtumanLaji/code/01', 'http://uri.suomi.fi/codelist/rytj/alueidenkaytonRajoituksenKasittelytapahtumanLaji/code/02', 'http://uri.suomi.fi/codelist/rytj/alueidenkaytonRajoituksenKasittelytapahtumanLaji/code/03', 'http://uri.suomi.fi/codelist/rytj/alueidenkaytonRajoituksenKasittelytapahtumanLaji/code/04')")
        return value
