...
class ReserveBuildingOrdinancePermanentIdentifierCommand(BaseModel):
    """
    ReserveBuildingOrdinancePermanentIdentifierCommand
    """ # noqa: E501
    administrative_area_identifier: Optional[StrictStr] = Field(default=None, alias="administrativeAreaIdentifier")
