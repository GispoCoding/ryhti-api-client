...
class GeneralRegulationGroup(BaseModel):
    ...
    """ # noqa: E501
    general_regulation_group_key: StrictStr = Field(description="Tiedon tuottajatahon tietojärjestelmän generoima kohteen versioriippumaton tunnus", alias="generalRegulationGroupKey")
    general_regulation_group_uri: Optional[StrictStr] = Field(default=None, description="Luokan pysyvä URI -muotoinen viittaustunniste (https://uri.rakennetunymparistontietojarjestelma.fi/generalregulationgroup/{guid})", alias="generalRegulationGroupUri")
    ...
    plan_regulations: Optional[List[PlanRegulation]] = Field(default=None, description="Kaavamääräykset", alias="planRegulations")
    ...
    __properties: ClassVar[List[str]] = ["generalRegulationGroupKey", "generalRegulationGroupUri", "titleOfPlanRegulation", "planRegulations", "planRecommendations", "groupNumber"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.plan_regulations is None and "plan_regulations" in self.model_fields_set:
