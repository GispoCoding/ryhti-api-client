...
class BuildingOrdinanceAttachmentDocument(BaseModel):
    ...
    building_ordinance_attachment_document_uri: Optional[StrictStr] = Field(
        default=None,
        description="Luokan pysyvä URI -muotoinen viittaustunniste (https://uri.rakennetunymparistontietojarjestelma.fi/buildingordinanceattachmentdocument/{guid})",
        alias="buildingOrdinanceAttachmentDocumentUri",
    )
    type_of_attachment: StrictStr = Field(
    ...
    document_creator_operators: Optional[List[BuildingOrdinanceOperator]] = Field(
        default=None,
        description="Asiakirjan laatijat",
        alias="documentCreatorOperators",
    )
    related_building_ordinance_documents: Optional[List[StrictStr]] = Field(
        default=None,
        description="Liiteasiakirjaan liittyvät muut liiteasiakirjat",
        alias="relatedBuildingOrdinanceDocuments",
    )
    __properties: ClassVar[List[str]] = [
        ...
        "documentDate",
        "arrivedDate",
        "buildingOrdinanceAttachmentDocumentUri",
        "typeOfAttachment",
    ...
    def type_of_attachment_validate_enum(cls, value):
        ...
        if value not in set(
            [
                "http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/01",
                "http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/02",
                "http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/03",
                "http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/04",
                "http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/05",
                "http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/06",
                "http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/07",
                "http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/08",
                "http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/09",
                "http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/10",
                "http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/11",
                "http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/12",
                "http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/13",
                "http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/14",
                "http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/15",
                "http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/99",
            ]
        ):
            raise ValueError(
                "must be one of enum values ('http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/01', 'http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/02', 'http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/03', 'http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/04', 'http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/05', 'http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/06', 'http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/07', 'http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/08', 'http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/09', 'http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/10', 'http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/11', 'http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/12', 'http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/13', 'http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/14', 'http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/15', 'http://uri.suomi.fi/codelist/rytj/asiakirjanLaji/code/99')"
            )
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # and model_fields_set contains the field
        if (
            self.related_building_ordinance_documents is None
            and "related_building_ordinance_documents" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "buildingOrdinanceAttachmentDocumentUri": obj.get(
                    "buildingOrdinanceAttachmentDocumentUri"
                ),
