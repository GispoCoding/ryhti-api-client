...
class Plan(BaseModel):
    ...
    plan_uri: Optional[StrictStr] = Field(
        default=None,
    ...
    life_cycle_status: StrictStr = Field(
        description='Kaavan elinkaaren tila. Käytetään koodistoa <a href="http://uri.suomi.fi/codelist/rytj/kaavaelinkaari">http://uri.suomi.fi/codelist/rytj/kaavaelinkaari</a>',
        alias="lifeCycleStatus",
    )
    legal_effect_of_local_master_plans: Optional[List[StrictStr]] = Field(
        default=None,
        description='Yleiskaavan oikeusvaikutteisuuden määritykset. Käytössä ainoastaan yleiskaavan yhteydessä. Käytetään koodistoa <a href="http://uri.suomi.fi/codelist/rytj/oikeusvaik_YK">http://uri.suomi.fi/codelist/rytj/oikeusvaik_YK</a>',
        alias="legalEffectOfLocalMasterPlans",
    )
    scale: Optional[StrictInt] = Field(default=None, description="Mittakaava")
    official_use_only: Optional[StrictBool] = Field(
        default=None, description="Vain viranomaiskäyttöön", alias="officialUseOnly"
    )
    plan_maps: Optional[List[PlanMap]] = Field(
        default=None, description="Kaavakartat", alias="planMaps"
    )
    geographical_area: RyhtiGeometry = Field(
        description="Aluerajaus", alias="geographicalArea"
    )
    plan_description: Optional[StrictStr] = Field(
        default=None, description="Kaavan kuvaus", alias="planDescription"
    )
    plan_annexes: Optional[List[PlanAttachmentDocument]] = Field(
        default=None, description="Kaavan liittet", alias="planAnnexes"
    )
    other_plan_materials: Optional[List[OtherPlanMaterial]] = Field(
        default=None, description="Muu kaava-aineisto", alias="otherPlanMaterials"
    )
    ...
    general_regulation_groups: Optional[List[GeneralRegulationGroup]] = Field(
        default=None, description="Kaavamääräysryhmät", alias="generalRegulationGroups"
    )
    presentation_alignments: Optional[List[PresentationAlignment]] = Field(
        default=None, description="Esitystavankohdistus", alias="presentationAlignments"
    )
    ...
    approval_date: Optional[date] = Field(
        default=None, description="Hyväksymispäivämäärä", alias="approvalDate"
    )
    planners: Optional[List[PlanOperator]] = Field(default=None, description="Laatija")
    plan_objects: Optional[List[PlanObject]] = Field(
        default=None, description="Kaavakohteet", alias="planObjects"
    )
    plan_regulation_groups: Optional[List[PlanRegulationGroup]] = Field(
        default=None,
        description="Kaavakohteen määräysryhmät",
        alias="planRegulationGroups",
    )
    plan_regulation_group_relations: Optional[List[PlanRegulationGroupRelations]] = (
        Field(
            default=None,
            description="Kaavakohteen ja määräysryhmän väliset suhteet",
            alias="planRegulationGroupRelations",
        )
    )
    related_plan_object_regulation_group_relations: Optional[
        List[RelatedPlanObjectRegulationGroupRelation]
    ] = Field(
        default=None,
        description="Ulkoisten kaavakohteiden ja sisäisten määräysryhmien relaatiot",
        alias="relatedPlanObjectRegulationGroupRelations",
    )
    related_regulation_group_plan_object_relations: Optional[
        List[RelatedRegulationGroupPlanObjectRelation]
    ] = Field(
        default=None,
        description="Ulkoisten määräysryhmien ja sisäisten kaavakohteiden relaatiot (vain get kutsuissa)",
        alias="relatedRegulationGroupPlanObjectRelations",
    )
        ...
        for i in value:
            if i not in set(
                [
                    ...
                    "http://uri.suomi.fi/codelist/rytj/oikeusvaik_YK/code/11",
                    "http://uri.suomi.fi/codelist/rytj/oikeusvaik_YK/code/12",
                    "http://uri.suomi.fi/codelist/rytj/oikeusvaik_YK/code/13",
                    "http://uri.suomi.fi/codelist/rytj/oikeusvaik_YK/code/2",
                ]
            ):
                raise ValueError(
                    "each list item must be one of ('http://uri.suomi.fi/codelist/rytj/oikeusvaik_YK/code/1', 'http://uri.suomi.fi/codelist/rytj/oikeusvaik_YK/code/11', 'http://uri.suomi.fi/codelist/rytj/oikeusvaik_YK/code/12', 'http://uri.suomi.fi/codelist/rytj/oikeusvaik_YK/code/13', 'http://uri.suomi.fi/codelist/rytj/oikeusvaik_YK/code/2')"
                )
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if (
            self.legal_effect_of_local_master_plans is None
            and "legal_effect_of_local_master_plans" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.official_use_only is None
            and "official_use_only" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.plan_description is None
            and "plan_description" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.other_plan_materials is None
            and "other_plan_materials" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.general_regulation_groups is None
            and "general_regulation_groups" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.presentation_alignments is None
            and "presentation_alignments" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.plan_regulation_groups is None
            and "plan_regulation_groups" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.plan_regulation_group_relations is None
            and "plan_regulation_group_relations" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.related_plan_object_regulation_group_relations is None
            and "related_plan_object_regulation_group_relations"
        ...
        # and model_fields_set contains the field
        if (
            self.related_regulation_group_plan_object_relations is None
            and "related_regulation_group_plan_object_relations"
            in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "legalEffectOfLocalMasterPlans": obj.get(
                    "legalEffectOfLocalMasterPlans"
                ),
                "scale": obj.get("scale"),
                "officialUseOnly": obj.get("officialUseOnly"),
                "planMaps": [PlanMap.from_dict(_item) for _item in obj["planMaps"]]
                if obj.get("planMaps") is not None
                else None,
                ...
                "planAnnexes": [
                    ...
                    for _item in obj["planAnnexes"]
                ]
                if obj.get("planAnnexes") is not None
                else None,
                "otherPlanMaterials": [
                    OtherPlanMaterial.from_dict(_item)
                    for _item in obj["otherPlanMaterials"]
                ]
                if obj.get("otherPlanMaterials") is not None
                else None,
                "planCancellationInfos": [
                ...
                "generalRegulationGroups": [
                    GeneralRegulationGroup.from_dict(_item)
                    for _item in obj["generalRegulationGroups"]
                ]
                if obj.get("generalRegulationGroups") is not None
                else None,
                "presentationAlignments": [
                    PresentationAlignment.from_dict(_item)
                    for _item in obj["presentationAlignments"]
                ]
                if obj.get("presentationAlignments") is not None
                else None,
                ...
                "planners": [PlanOperator.from_dict(_item) for _item in obj["planners"]]
                if obj.get("planners") is not None
                else None,
                "planObjects": [
                    PlanObject.from_dict(_item) for _item in obj["planObjects"]
                ]
                if obj.get("planObjects") is not None
                else None,
                "planRegulationGroups": [
                    PlanRegulationGroup.from_dict(_item)
                    for _item in obj["planRegulationGroups"]
                ]
                if obj.get("planRegulationGroups") is not None
                else None,
                "planRegulationGroupRelations": [
                    PlanRegulationGroupRelations.from_dict(_item)
                    for _item in obj["planRegulationGroupRelations"]
                ]
                if obj.get("planRegulationGroupRelations") is not None
                else None,
                "relatedPlanObjectRegulationGroupRelations": [
                    RelatedPlanObjectRegulationGroupRelation.from_dict(_item)
                    for _item in obj["relatedPlanObjectRegulationGroupRelations"]
                ]
                if obj.get("relatedPlanObjectRegulationGroupRelations") is not None
                else None,
                "relatedRegulationGroupPlanObjectRelations": [
                    RelatedRegulationGroupPlanObjectRelation.from_dict(_item)
                    for _item in obj["relatedRegulationGroupPlanObjectRelations"]
                ]
                if obj.get("relatedRegulationGroupPlanObjectRelations") is not None
                else None,
            }
        )
        return _obj
