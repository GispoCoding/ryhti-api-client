...
class PlanSourceData(BaseModel):
    ...
    Lähtötietoaineisto
    """ # noqa: E501
    plan_source_data_key: StrictStr = Field(description="Tiedon tuottajatahon tietojärjestelmän generoima kohteen versioriippumaton tunnus", alias="planSourceDataKey")
    plan_source_data_uri: Optional[StrictStr] = Field(default=None, description="Luokan pysyvä URI -muotoinen viittaustunniste (https://uri.rakennetunymparistontietojarjestelma.fi/plansourcedata/{guid})", alias="planSourceDataUri")
    type: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Aineiston tyyppi. Käytetään koodistoa <a href=\"http://uri.suomi.fi/codelist/rytj/RY_LahtotietoaineistonLaji\">http://uri.suomi.fi/codelist/rytj/RY_LahtotietoaineistonLaji</a>")
    ...
    geographical_area: Optional[RyhtiGeometry] = Field(default=None, description="Aluerajaus", alias="geographicalArea")
    ...
    __properties: ClassVar[List[str]] = ["planSourceDataKey", "planSourceDataUri", "type", "name", "geographicalArea", "additionalInformationLink", "files"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # and model_fields_set contains the field
        if self.geographical_area is None and "geographical_area" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "files": [PlanAttachmentDocument.from_dict(_item) for _item in obj["files"]] if obj.get("files") is not None else None
        })
        return _obj
