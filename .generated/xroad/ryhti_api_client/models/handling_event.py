...
class HandlingEvent(BaseModel):
    ...
    Käsittelytapahtuma
    """ # noqa: E501
    handling_event_key: StrictStr = Field(description="Tiedon tuottajatahon tietojärjestelmän generoima kohteen versioriippumaton tunnus", alias="handlingEventKey")
    handling_event_uri: Optional[StrictStr] = Field(default=None, description="Luokan pysyvä URI -muotoinen viittaustunniste (https://uri.rakennetunymparistontietojarjestelma.fi/handlingevent/{guid})", alias="handlingEventUri")
    handling_event_type: StrictStr = Field(description="Käsittelytapahtuman tyyppi. Käytetään koodistoa <a href=\"http://uri.suomi.fi/codelist/rytj/kaavakastap\">http://uri.suomi.fi/codelist/rytj/kaavakastap</a>", alias="handlingEventType")
