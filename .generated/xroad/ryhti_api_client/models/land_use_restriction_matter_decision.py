...
class LandUseRestrictionMatterDecision(BaseModel):
    ...
    """ # noqa: E501
    land_use_restriction_matter_decision_key: StrictStr = Field(description="Avain", alias="landUseRestrictionMatterDecisionKey")
    land_use_restriction_matter_decision_uri: Optional[StrictStr] = Field(default=None, alias="landUseRestrictionMatterDecisionUri")
    ...
    decision_documents: Annotated[List[LandUseRestrictionAttachmentDocument], Field(min_length=1)] = Field(description="Päätösasiakirjat", alias="decisionDocuments")
    decision_maker: LandUseRestrictionOperator = Field(description="Päätöksentekijä", alias="decisionMaker")
    ...
    type_of_decision_maker: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Päättäjän laji. Käytetään koodistoa <a href=\"http://uri.suomi.fi/codelist/rytj/PaatoksenTekija\">http://uri.suomi.fi/codelist/rytj/PaatoksenTekija</a>", alias="typeOfDecisionMaker")
    ...
    land_use_restriction: Optional[LandUseRestriction] = Field(default=None, description="Alueidenkäytön rajoitus", alias="landUseRestriction")
    __properties: ClassVar[List[str]] = ["landUseRestrictionMatterDecisionKey", "landUseRestrictionMatterDecisionUri", "decisionDate", "dateOfDecision", "dateOfValidity", "decisionDocuments", "decisionMaker", "name", "typeOfDecisionMaker", "decisionIdentifier", "statute", "landUseRestriction"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # and model_fields_set contains the field
        if self.land_use_restriction is None and "land_use_restriction" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "landUseRestrictionMatterDecisionKey": obj.get("landUseRestrictionMatterDecisionKey"),
            "landUseRestrictionMatterDecisionUri": obj.get("landUseRestrictionMatterDecisionUri"),
            "decisionDate": obj.get("decisionDate"),
            "dateOfDecision": obj.get("dateOfDecision"),
            "dateOfValidity": obj.get("dateOfValidity"),
            "decisionDocuments": [LandUseRestrictionAttachmentDocument.from_dict(_item) for _item in obj["decisionDocuments"]] if obj.get("decisionDocuments") is not None else None,
            "decisionMaker": LandUseRestrictionOperator.from_dict(obj["decisionMaker"]) if obj.get("decisionMaker") is not None else None,
            "name": obj.get("name"),
            ...
            "landUseRestriction": LandUseRestriction.from_dict(obj["landUseRestriction"]) if obj.get("landUseRestriction") is not None else None
        })
        return _obj
