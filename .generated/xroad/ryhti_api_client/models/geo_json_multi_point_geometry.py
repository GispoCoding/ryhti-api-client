...
class GeoJsonMultiPointGeometry(BaseModel):
    """
    MultiPoint GeoJson    Esimerkki: { \"type\": \"multiPoint\", \"coordinates\": [ [100.0, 0.0], [101.0, 1.0] ] }
    """ # noqa: E501
    coordinates: List[List[Union[StrictFloat, StrictInt]]] = Field(description="Koordinaatit")
    type: StrictStr = Field(description="Geometriatyyppi. Pakollinen arvo: \"multiPoint\"")
