...
class ParticipationAndAssessmentScheme(BaseModel):
    ...
    participation_and_assessment_scheme_key: StrictStr = Field(
        description="Tiedon tuottajatahon tietojärjestelmän generoima kohteen versioriippumaton tunnus",
        alias="participationAndAssessmentSchemeKey",
    )
    participation_and_assessment_scheme_uri: Optional[StrictStr] = Field(
        default=None,
        ...
        alias="participationAndAssessmentSchemeUri",
    )
    attachment_documents: Annotated[
        List[PlanAttachmentDocument], Field(min_length=1)
    ] = Field(alias="attachmentDocuments")
    __properties: ClassVar[List[str]] = [
        "participationAndAssessmentSchemeKey",
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "participationAndAssessmentSchemeKey": obj.get(
                    "participationAndAssessmentSchemeKey"
                ),
                "participationAndAssessmentSchemeUri": obj.get(
                    "participationAndAssessmentSchemeUri"
                ),
                "attachmentDocuments": [
