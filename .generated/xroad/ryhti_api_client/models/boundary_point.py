...
class BoundaryPoint(BaseModel):
    ...
    Rajapiste
    """ # noqa: E501
    boundary_point_or_peg_id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Rajapisteen tai rajapyykin tunnus", alias="boundaryPointOrPegId")
    geometry: RyhtiGeometry = Field(description="Pistegeometria (Geometriatyypin oltava GeoJsonPointGeometryGeoJsonPointGeometry)")
