...
class PlanRecommendation(BaseModel):
    ...
    Kaavasuositus
    """ # noqa: E501
    plan_recommendation_key: StrictStr = Field(description="Tiedon tuottajatahon tietojärjestelmän generoima kohteen versioriippumaton tunnus", alias="planRecommendationKey")
    plan_recommendation_uri: Optional[StrictStr] = Field(default=None, description="Luokan pysyvä URI -muotoinen viittaustunniste (https://uri.rakennetunymparistontietojarjestelma.fi/planrecommendation/{guid})", alias="planRecommendationUri")
    value: LanguageString = Field(description="Lokalisoitu merkkijono-luokka eri kielille. Lisää vähintään yksi kieli.")
    life_cycle_status: StrictStr = Field(description="Kaavasuosituksen elinkaaren tila. Käytetään koodistoa <a href=\"http://uri.suomi.fi/codelist/rytj/kaavaelinkaari\">http://uri.suomi.fi/codelist/rytj/kaavaelinkaari</a>", alias="lifeCycleStatus")
    related_documents: Optional[List[PlanAttachmentDocument]] = Field(default=None, description="LiittyväAsiakirja", alias="relatedDocuments")
    plan_themes: Optional[List[StrictStr]] = Field(default=None, description="Kaavasuosituksen teemoittelu. Käytetään koodistoa <a href=\"http://uri.suomi.fi/codelist/rytj/kaavoitusteema\">http://uri.suomi.fi/codelist/rytj/kaavoitusteema</a>", alias="planThemes")
    period_of_validity: Optional[TimePeriodDateOnly] = Field(default=None, description="VoimassaoloAika", alias="periodOfValidity")
    recommendation_number: Optional[StrictInt] = Field(default=None, description="Suositusnumero", alias="recommendationNumber")
    __properties: ClassVar[List[str]] = ["planRecommendationKey", "planRecommendationUri", "value", "lifeCycleStatus", "relatedDocuments", "planThemes", "periodOfValidity", "recommendationNumber"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # and model_fields_set contains the field
        if self.recommendation_number is None and "recommendation_number" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": LanguageString.from_dict(obj["value"]) if obj.get("value") is not None else None,
