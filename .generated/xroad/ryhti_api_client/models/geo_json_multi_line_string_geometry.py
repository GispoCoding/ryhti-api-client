...
class GeoJsonMultiLineStringGeometry(BaseModel):
    ...
    """ # noqa: E501
    coordinates: List[List[List[Union[StrictFloat, StrictInt]]]] = Field(description="Koordinaatit")
    type: StrictStr = Field(description="Geometriatyyppi. Pakollinen arvo: \"lineString\"")
