...
class BindingPlotDivisionMatterResponse(BaseModel):
    ...
    binding_plot_division_matter_uri: Optional[StrictStr] = Field(
        default=None,
        ...
        alias="bindingPlotDivisionMatterUri",
    )
    original_administrative_area_identifiers: List[StrictStr] = Field(
        alias="originalAdministrativeAreaIdentifiers"
    )
    phases: Optional[List[BindingPlotDivisionMatterPhase]] = Field(
        default=None, description="Vaiheet"
    )
