...
class BindingPlotDivisionOperator(BaseModel):
    ...
    binding_plot_division_operator_key: StrictStr = Field(
        description="Toimijan avain", alias="bindingPlotDivisionOperatorKey"
    )
    binding_plot_division_operator_uri: Optional[StrictStr] = Field(
        default=None,
        ...
        alias="bindingPlotDivisionOperatorUri",
    )
    first_name: Optional[StrictStr] = Field(
        default=None, description="Etunimi", alias="firstName"
    )
    last_name: Optional[StrictStr] = Field(
        default=None, description="Sukunimi", alias="lastName"
    )
    title: Optional[StrictStr] = Field(default=None, description="Nimike")
    organization_name: Optional[StrictStr] = Field(
        default=None, description="Organisaation nimi", alias="organizationName"
    )
    business_id: Optional[StrictStr] = Field(
        default=None, description="Y-tunnus", alias="businessId"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "bindingPlotDivisionOperatorKey": obj.get(
                    "bindingPlotDivisionOperatorKey"
                ),
                "bindingPlotDivisionOperatorUri": obj.get(
                    "bindingPlotDivisionOperatorUri"
                ),
