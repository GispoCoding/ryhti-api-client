...
class GeoJsonMultiPolygonGeometry(BaseModel):
    ...
    """ # noqa: E501
    coordinates: List[List[List[List[Union[StrictFloat, StrictInt]]]]] = Field(description="Koordinaatit")
    type: StrictStr = Field(description="Geometriatyyppi. Pakollinen arvo: \"multiPolygon\"")
