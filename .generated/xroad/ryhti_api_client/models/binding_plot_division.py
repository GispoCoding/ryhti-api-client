...
class BindingPlotDivision(BaseModel):
    ...
    Sitova tonttijako
    """ # noqa: E501
    binding_plot_division_key: StrictStr = Field(description="Sitova tonttijako avain", alias="bindingPlotDivisionKey")
    binding_plot_division_uri: Optional[StrictStr] = Field(default=None, description="Luokan pysyvä URI -muotoinen viittaustunniste (https://uri.rakennetunymparistontietojarjestelma.fi/bindingplotdivision/{guid})", alias="bindingPlotDivisionUri")
    binding_plot_division_cancellation_infos: Optional[List[BindingPlotDivisionCancellationInfo]] = Field(default=None, description="Sitovan tonttijaon kumoutumistieto", alias="bindingPlotDivisionCancellationInfos")
    plot_division_plots: Annotated[List[PlotDivisionPlot], Field(min_length=1)] = Field(description="Tonttijakotontit", alias="plotDivisionPlots")
    period_of_validity: TimePeriodDateOnly = Field(description="Voimassaolo aika", alias="periodOfValidity")
    geographical_area: RyhtiGeometry = Field(description="Aluerajaus", alias="geographicalArea")
    boundary_points: Annotated[List[BoundaryPoint], Field(min_length=3)] = Field(description="Rajapisteet", alias="boundaryPoints")
    accesses_to_road: Optional[List[AccessToRoad]] = Field(default=None, description="Kulkuhteydet", alias="accessesToRoad")
    __properties: ClassVar[List[str]] = ["bindingPlotDivisionKey", "bindingPlotDivisionUri", "bindingPlotDivisionCancellationInfos", "plotDivisionPlots", "periodOfValidity", "geographicalArea", "boundaryPoints", "accessesToRoad"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.binding_plot_division_cancellation_infos:
            for _item_binding_plot_division_cancellation_infos in self.binding_plot_division_cancellation_infos:
                if _item_binding_plot_division_cancellation_infos:
                    _items.append(_item_binding_plot_division_cancellation_infos.to_dict())
        ...
        if self.binding_plot_division_cancellation_infos is None and "binding_plot_division_cancellation_infos" in self.model_fields_set:
            _dict['bindingPlotDivisionCancellationInfos'] = None

        # set to None if accesses_to_road (nullable) is None
        # and model_fields_set contains the field
        if self.accesses_to_road is None and "accesses_to_road" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bindingPlotDivisionCancellationInfos": [BindingPlotDivisionCancellationInfo.from_dict(_item) for _item in obj["bindingPlotDivisionCancellationInfos"]] if obj.get("bindingPlotDivisionCancellationInfos") is not None else None,
            "plotDivisionPlots": [PlotDivisionPlot.from_dict(_item) for _item in obj["plotDivisionPlots"]] if obj.get("plotDivisionPlots") is not None else None,
            ...
            "boundaryPoints": [BoundaryPoint.from_dict(_item) for _item in obj["boundaryPoints"]] if obj.get("boundaryPoints") is not None else None,
            "accessesToRoad": [AccessToRoad.from_dict(_item) for _item in obj["accessesToRoad"]] if obj.get("accessesToRoad") is not None else None
        })
        return _obj
