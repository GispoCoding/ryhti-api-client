...
class PlanOperator(BaseModel):
    """
    Toimija
    """ # noqa: E501
    plan_operator_key: StrictStr = Field(description="Tiedon tuottajatahon tietojärjestelmän generoima kohteen versioriippumaton tunnus", alias="planOperatorKey")
    plan_operator_uri: Optional[StrictStr] = Field(default=None, description="Luokan pysyvä URI -muotoinen viittaustunniste (https://uri.rakennetunymparistontietojarjestelma.fi/planoperator/{guid})", alias="planOperatorUri")
    ...
    organization_name: Optional[StrictStr] = Field(default=None, description="OrganisaatioNimi", alias="organizationName")
    business_id: Optional[StrictStr] = Field(default=None, description="Y-tunnus", alias="businessId")
    __properties: ClassVar[List[str]] = ["planOperatorKey", "planOperatorUri", "firstName", "lastName", "title", "organizationName", "businessId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "planOperatorKey": obj.get("planOperatorKey"),
            "planOperatorUri": obj.get("planOperatorUri"),
