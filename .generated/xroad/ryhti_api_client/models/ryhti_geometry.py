...
class RyhtiGeometry(BaseModel):
    ...
    def srid_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['3067', '3873', '3874', '3875', '3876', '3877', '3878', '3879', '3880', '3881', '3882', '3883', '3884', '3885', '4326']):
            raise ValueError("must be one of enum values ('3067', '3873', '3874', '3875', '3876', '3877', '3878', '3879', '3880', '3881', '3882', '3883', '3884', '3885', '4326')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "srid": obj.get("srid"),
            "geometry": RyhtiGeometryGeometry.from_dict(obj["geometry"]) if obj.get("geometry") is not None else None
        })
        return _obj
