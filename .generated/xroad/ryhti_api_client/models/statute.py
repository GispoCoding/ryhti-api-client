...
class Statute(BaseModel):
    ...
    name_of_statute: LanguageString = Field(
    ...
    subparagraphs: Optional[List[StrictStr]] = Field(
        default=None, description="Alakohdat"
    )
    __properties: ClassVar[List[str]] = [
        "nameOfStatute",
        "numberOfStatuteCollection",
        "yearOfStatuteCollection",
        "chapter",
        "section",
        "subsections",
        "paragraphs",
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "nameOfStatute": LanguageString.from_dict(obj["nameOfStatute"])
                if obj.get("nameOfStatute") is not None
                else None,
