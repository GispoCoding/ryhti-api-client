...
class RelatedPlan(BaseModel):
    ...
    related_plan_uri: Optional[StrictStr] = Field(
        default=None,
    ...
    related_producer_plan_identifier: Optional[StrictStr] = Field(
        ...
        alias="relatedProducerPlanIdentifier",
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            self.related_plan_uri is None
            and "related_plan_uri" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.related_producer_plan_identifier is None
            and "related_producer_plan_identifier" in self.model_fields_set
        ):
