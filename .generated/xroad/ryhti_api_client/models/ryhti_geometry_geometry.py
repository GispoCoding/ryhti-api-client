...
RYHTIGEOMETRYGEOMETRY_ONE_OF_SCHEMAS = ["GeoJsonLineStringGeometry", "GeoJsonMultiLineStringGeometry", "GeoJsonMultiPointGeometry", "GeoJsonMultiPolygonGeometry", "GeoJsonPointGeometry", "GeoJsonPolygonGeometry"]
...
class RyhtiGeometryGeometry(BaseModel):
    ...
    actual_instance: Optional[Union[GeoJsonLineStringGeometry, GeoJsonMultiLineStringGeometry, GeoJsonMultiPointGeometry, GeoJsonMultiPolygonGeometry, GeoJsonPointGeometry, GeoJsonPolygonGeometry]] = None
    one_of_schemas: Set[str] = { "GeoJsonLineStringGeometry", "GeoJsonMultiLineStringGeometry", "GeoJsonMultiPointGeometry", "GeoJsonMultiPolygonGeometry", "GeoJsonPointGeometry", "GeoJsonPolygonGeometry" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, GeoJsonPointGeometry):
            error_messages.append(f"Error! Input type `{type(v)}` is not `GeoJsonPointGeometry`")
        else:
            match += 1
        # validate data type: GeoJsonMultiPointGeometry
        if not isinstance(v, GeoJsonMultiPointGeometry):
            error_messages.append(f"Error! Input type `{type(v)}` is not `GeoJsonMultiPointGeometry`")
        else:
            match += 1
        # validate data type: GeoJsonLineStringGeometry
        if not isinstance(v, GeoJsonLineStringGeometry):
            error_messages.append(f"Error! Input type `{type(v)}` is not `GeoJsonLineStringGeometry`")
        else:
            match += 1
        # validate data type: GeoJsonMultiLineStringGeometry
        if not isinstance(v, GeoJsonMultiLineStringGeometry):
            error_messages.append(f"Error! Input type `{type(v)}` is not `GeoJsonMultiLineStringGeometry`")
        else:
            match += 1
        # validate data type: GeoJsonPolygonGeometry
        if not isinstance(v, GeoJsonPolygonGeometry):
            error_messages.append(f"Error! Input type `{type(v)}` is not `GeoJsonPolygonGeometry`")
        else:
            match += 1
        # validate data type: GeoJsonMultiPolygonGeometry
        if not isinstance(v, GeoJsonMultiPolygonGeometry):
            error_messages.append(f"Error! Input type `{type(v)}` is not `GeoJsonMultiPolygonGeometry`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in RyhtiGeometryGeometry with oneOf schemas: GeoJsonLineStringGeometry, GeoJsonMultiLineStringGeometry, GeoJsonMultiPointGeometry, GeoJsonMultiPolygonGeometry, GeoJsonPointGeometry, GeoJsonPolygonGeometry. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in RyhtiGeometryGeometry with oneOf schemas: GeoJsonLineStringGeometry, GeoJsonMultiLineStringGeometry, GeoJsonMultiPointGeometry, GeoJsonMultiPolygonGeometry, GeoJsonPointGeometry, GeoJsonPolygonGeometry. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            instance.actual_instance = GeoJsonMultiLineStringGeometry.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into RyhtiGeometryGeometry with oneOf schemas: GeoJsonLineStringGeometry, GeoJsonMultiLineStringGeometry, GeoJsonMultiPointGeometry, GeoJsonMultiPolygonGeometry, GeoJsonPointGeometry, GeoJsonPolygonGeometry. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into RyhtiGeometryGeometry with oneOf schemas: GeoJsonLineStringGeometry, GeoJsonMultiLineStringGeometry, GeoJsonMultiPointGeometry, GeoJsonMultiPolygonGeometry, GeoJsonPointGeometry, GeoJsonPolygonGeometry. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], GeoJsonLineStringGeometry, GeoJsonMultiLineStringGeometry, GeoJsonMultiPointGeometry, GeoJsonMultiPolygonGeometry, GeoJsonPointGeometry, GeoJsonPolygonGeometry]]:
