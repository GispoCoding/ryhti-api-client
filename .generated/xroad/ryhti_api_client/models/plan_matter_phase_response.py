...
class PlanMatterPhaseResponse(BaseModel):
    ...
    plan_matter_phase_uri: Optional[StrictStr] = Field(default=None, description="Luokan pysyvä URI -muotoinen viittaustunniste (https://uri.rakennetunymparistontietojarjestelma.fi/planmatterphase/{guid})", alias="planMatterPhaseUri")
    life_cycle_status: Optional[StrictStr] = Field(default=None, alias="lifeCycleStatus")
    geographical_area: Optional[RyhtiGeometry] = Field(default=None, alias="geographicalArea")
    handling_event: Optional[HandlingEvent] = Field(default=None, description="Käsittelytapahtuma", alias="handlingEvent")
    interaction_events: Optional[List[InteractionEvent]] = Field(default=None, alias="interactionEvents")
    plan_decision: Optional[PlanDecision] = Field(default=None, description="Kaavapäätös", alias="planDecision")
    previous_phase_key: Optional[StrictStr] = Field(default=None, alias="previousPhaseKey")
    next_phase_key: Optional[StrictStr] = Field(default=None, alias="nextPhaseKey")
    __properties: ClassVar[List[str]] = ["planMatterPhaseKey", "planMatterPhaseUri", "lifeCycleStatus", "geographicalArea", "handlingEvent", "interactionEvents", "planDecision", "previousPhaseKey", "nextPhaseKey"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # and model_fields_set contains the field
        if self.previous_phase_key is None and "previous_phase_key" in self.model_fields_set:
