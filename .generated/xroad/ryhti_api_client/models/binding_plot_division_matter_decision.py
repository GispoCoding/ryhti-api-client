...
class BindingPlotDivisionMatterDecision(BaseModel):
    ...
    binding_plot_division_matter_decision_uri: Optional[StrictStr] = Field(
        default=None,
        ...
        alias="bindingPlotDivisionMatterDecisionUri",
    )
    ...
    decision_documents: Annotated[
        List[BindingPlotDivisionAttachmentDocument], Field(min_length=1)
    ...
    type_of_decision_maker: Annotated[str, Field(min_length=1, strict=True)] = Field(
        description='Päättäjän laji, monijäseninen toimielin tai viranhaltija. Käytetään koodistoa <a href="http://uri.suomi.fi/codelist/rytj/PaatoksenTekija">http://uri.suomi.fi/codelist/rytj/PaatoksenTekija</a>',
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "bindingPlotDivisionMatterDecisionKey": obj.get(
                    "bindingPlotDivisionMatterDecisionKey"
                ),
                "bindingPlotDivisionMatterDecisionUri": obj.get(
                    "bindingPlotDivisionMatterDecisionUri"
                ),
                ...
                "decisionMaker": BindingPlotDivisionOperator.from_dict(
                    obj["decisionMaker"]
                )
