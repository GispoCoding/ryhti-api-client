...
class PlanMatterPhase(BaseModel):
    ...
    plan_matter_phase_key: StrictStr = Field(
        description="Tiedon tuottajatahon tietojärjestelmän generoima kohteen versioriippumaton tunnus",
        alias="planMatterPhaseKey",
    )
    life_cycle_status: StrictStr = Field(
        description='Asian elinkaaren tila. Käytetään koodistoa <a href="http://uri.suomi.fi/codelist/rytj/kaavaelinkaari">http://uri.suomi.fi/codelist/rytj/kaavaelinkaari</a>',
    ...
    interaction_events: Optional[List[InteractionEvent]] = Field(
        default=None, description="Vuorovaikutustapahtuma", alias="interactionEvents"
    )
